...
def main(args):
    ...
    args.data_args = {'train_csv_path': '/m2v_intern/precomputed_latents/250606_laion5b_cogvlm_30M/rater_csv/250606_laion5b_cogvlm_30M_trainset_withRating0828_sorted.csv', "cogvlm":True}
